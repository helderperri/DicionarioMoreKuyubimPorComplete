...
public class DatabaseEntriesGlossesAdapter {
    ...
    public List<GetEntriesGlossesTableValues> getEntriesGlosses(){
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM " + DatabaseHelper.TABLE_NAME + " WHERE entry_bundle_id = " + entryBundleId + " AND lang_code = '" + langCodeSearch + "'", null);
    ...
    public List<GetEntriesGlossesTableValues> getGlossesToSearchDisplay(){
    ...
    public List<GetEntriesGlossesTableValues> getGlossesToSearchDisplayByGlyph(String glyph){
        langCodeSearch = context.getResources().getString(R.string.target_lang_code);

        Cursor cursor = db.rawQuery("SELECT * FROM " + DatabaseHelper.TABLE_NAME + " WHERE gloss LIKE '" + glyph + "%' AND lang_code = '" + langCodeSearch + "' ORDER BY " + DatabaseHelper.KEY_GLOSS + " COLLATE UNICODE", null);
        //StringBuffer buffer = new StringBuffer();
        try{
        while(cursor.moveToNext()){
    ...
    public List<GetEntriesGlossesTableValues> getGlossesToSearchDisplayByGlyphId(long glyphId){
        langCodeSearch = context.getResources().getString(R.string.target_lang_code);

        Cursor cursor = db.rawQuery("SELECT * FROM " + DatabaseHelper.TABLE_NAME + " WHERE glyph_id = " + glyphId + " AND lang_code = '" + langCodeSearch +"' ORDER BY " + DatabaseHelper.KEY_GLOSS + " COLLATE UNICODE", null);
        //StringBuffer buffer = new StringBuffer();
        try{
        while(cursor.moveToNext()){
